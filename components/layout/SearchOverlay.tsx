        ...
        <div className="max-w-200 mx-auto px-4 sm:px-6 py-6">
          ...
          <div className="flex items-center gap-3 border-b-2 border-[#141718] pb-3">
            ...
            <input
              ...
              className="flex-1 text-lg text-[#141718] placeholder:text-[#6C7275] outline-none bg-transparent font-poppins"
            />
            <button
              onClick={onClose}
                ...
                {results.map((product) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="text-sm font-semibold text-[#141718] truncate group-hover:underline">
                        {product.title}
                      </h4>
                      {product.category && (
