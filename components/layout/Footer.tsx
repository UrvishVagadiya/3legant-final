      ...
      <div className="px-5 md:px-10 lg:px-40 py-12 md:py-18 w-full">
        <div className="flex flex-col md:flex-row justify-between mb-8 md:mb-19 text-white items-center gap-8 md:gap-0">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-5">
            <h3 className="text-3xl md:text-2xl font-medium">3legant.</h3>
            <div className="hidden md:block w-px h-6 bg-gray-500"></div>
            <div className="md:hidden w-8 h-px bg-gray-500 mt-1 mb-2"></div>
            <h3 className="text-sm text-[#E8ECEF]">Gift & Decoration Store</h3>
          </div>
        ...
        <div className="flex flex-col-reverse md:flex-row text-white justify-between items-center gap-8 md:gap-0">
          <div className="flex flex-col md:flex-row items-center gap-5 md:gap-6 text-xs md:text-sm">
            <h3 className="text-[#E8ECEF] md:mr-4 order-3 md:order-1 text-center md:text-left mt-4 md:mt-0">
              Copyright © 2023 3legant. All rights reserved
            </h3>
            <h3 className="font-semibold order-1 md:order-2 cursor-pointer hover:underline transition-all duration-300 ease-in-out">
              Privacy Policy
            </h3>
            <h3 className="font-semibold order-2 md:order-3 cursor-pointer hover:underline transition-all duration-300 ease-in-out">
              Terms of Use
            </h3>
          </div>
